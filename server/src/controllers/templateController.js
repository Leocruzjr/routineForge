...
const TEMPLATES = [
  {
    ...
    type: 'MORNING',
    description: 'A science-backed morning routine for optimal energy and focus. Estimated 30 min.',
  ...
  },
  {
    ...
    type: 'BEDTIME',
    description: 'A science-backed bedtime routine for better sleep quality. Estimated 45 min.',
    difficulty: 'COMMITTED',
    scheduledTime: '22:00',
    daysOfWeek: [0, 1, 2, 3, 4, 5, 6],
    steps: [
  ...
  },
  {
    ...
    type: 'MORNING',
    description: 'The minimum viable morning — just 3 steps, Estimated 10 min. Start small.',
    difficulty: 'EASY',
    scheduledTime: '07:00',
  ...
  },
  {
    ...
    name: 'Weekend Reset',
    type: 'MORNING',
    description: 'A gentler weekend routine — flexible timing, core anchors only. Estimated 20 min.',
    difficulty: 'MODERATE',
    scheduledTime: '09:00',
    daysOfWeek: [0, 6],
    steps: [
